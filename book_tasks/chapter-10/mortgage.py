def find_payment(loan, r, m):
    ...
    loan at a montly rate of r for m months
    """
    return loan*((r*(1+r)**m)/((1+r)**m - 1))

class Mortgage(object):
    """Abtract class for building different kinds of mortgages"""
...
class Two_rate(Mortgage):
    def __init__(self, loan, r, months, teaser_rate, teaser_months):
        ...
        self.next_rate = r/12
        self._legend = f"{100*teaser_rate:.1f}% for {teaser_months} months, then {100*r:1.f}"
